    ...
    <form>
      ...
      <div class="row">
        <div class="col-md-2">
          ...
          <input type="text" name="C7_NUM" maxlength="6" class="form-control  form-control-alternative input-sm"
            placeholder="Número Pedido">
        </div>
        <div class="col-md-2">
          <label class="form-control-label">Emissao</label>
          <input type="text" name="C7_EMISSAO" class="form-control form-control-alternative input-sm datepicker"
            value="{{ date('d/m/Y')}}" placeholder="Emissão">
        </div>
        <div class="col-md-3">
